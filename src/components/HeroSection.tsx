...
const HeroSection = ({ onCTAClick = () => {} }: HeroSectionProps) => {
  ...
  }, [typedLength, subtitleSentence, hasGridBuilt]);

  return (
    <div
      ref={containerRef}
      className="relative w-full min-h-[800px] overflow-hidden bg-background flex items-center justify-center px-4 sm:px-6 lg:px-8"
    >
      <div className="absolute inset-0 overflow-hidden">
        ...
        {/* Light-mode ambient shapes */}
        {/* Ambient rotating squares in light mode */}
